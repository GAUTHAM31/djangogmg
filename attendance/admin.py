...
from .models import employee,r_leave,public_holidays, admins, managedby,att_record,editlogs
...
class editlogsAdmin(admin.ModelAdmin):
    list_display = ['logid','admin_id','logdata','logdate']
...
admin.site.register(editlogs,editlogsAdmin)
